...
function promedio2(){
    ...
    materia = prompt ("ingreae la materia que imparte");
    estudiante = prompt ("ingrese los nombres de los estudiantes");
    nNotas = parseInt(prompt("ingrese el numeo de notas o calificacio"))


    While (iteracion<=nNotas) {
        calificacion = parseInt(prompt("ingrese calificacion"))
